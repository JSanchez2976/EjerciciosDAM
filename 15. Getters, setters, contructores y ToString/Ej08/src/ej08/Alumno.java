...
Visualizar la cantidad de alumnos aprobados y el número de alumnos suspendidos. 
 */
public class Alumno {
	...
	public void setNota(double nota,double notaMin) {
		if (nota >= 1 && nota <= 10) {
			...
			System.out.println("ERROR: La nota debe estar entre 1 y 10. Se establecerá en 1 por defecto.");
			this.nota = 1;
			this.notaMin=9;
		}
	}
